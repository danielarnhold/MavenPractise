...
import de.arnhold.informatik.meldeauskunft.domain.*;
import de.arnhold.informatik.meldeauskunft.repository.*;
import de.arnhold.informatik.meldeauskunft.service.*;
...
public class ResidentServiceTest {
	...
	public void testGetFilteredResidentsList2()
	{
		...
		ResidentService rs = new BaseResidentService();
		((BaseResidentService) rs).setResidentRepository(stub);
		List<Resident> result = rs.getFilteredResidentsList(new Resident("Martina", "Mustermann", "Albertstraße", "Musterdorf", new Date()));

		assertEquals(1, result.size());
		assertEquals("Martina", result.get(0).getGivenName());
		assertEquals("Mustermann", result.get(0).getFamilyName());
		assertEquals("Albertstraße", result.get(0).getStreet());
